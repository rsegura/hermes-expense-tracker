...
MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "done_pairing_help": "[dim]Message your bot → Hermes shows a code → hermes -p <slug> pairing approve telegram CODE[/dim]",
    ...
    "es": {
        ...
        "done_pairing_help": "[dim]Escribile al bot → Hermes muestra un código → hermes -p <slug> pairing approve telegram CODIGO[/dim]",
